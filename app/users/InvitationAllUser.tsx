...
import CoverScreen from "@/app/i/[token]/CoverScreen";
import IntroScene from "@/app/i/[token]/IntroScene";
import { MusicProvider } from "@/app/i/[token]/MusicProvider";
import {
  KnotRing,
  MongolianMeander,
  OrnamentDivider,
...
const SCENES = [
  { key: "hero", duration: 8000 },
  { key: "invite-hero", duration: 12000 },
  { key: "gallery", duration: 13000 },
  { key: "blessing", duration: 9000 },
  { key: "date", duration: 8000 },
  { key: "venue", duration: 9000 },
  { key: "horse", duration: 7000 },
  { key: "hosts", duration: 6000 },
  { key: "rsvp", duration: 6000 },
] as const;
...
const CONTENT = {
  ...
  mapsUrl:
    "https://www.google.com/maps/search/?api=1&query=46.5641977,106.8112311",
  mapEmbedUrl:
...
export default function InvitationAllUser() {
  ...
  const greetingClosing =
    'гэр бүлийн хамт хаан бугуйвчаар жаргал нэгтгэж хатан сүйхээр заяа зангидаж буй бидний "Шинэ гэрийн найр"-нд хүрэлцэн ирэхийг урьж байна.';
  ...
  const MUSIC_BY_STAGE: Record<string, string> = {
    intro: "/assets/morin_huur.mp3",
    cover: "/assets/morin_huur.mp3",
    invite: "",
  };

  return (
    <div className={`${display.variable} ${body.variable} ${caption.variable}`}>
      <MusicProvider src={MUSIC_BY_STAGE[stage]}>
        {stage === "intro" && (
          <IntroScene
            coupleInitials="Урилга"
            ...
            <Reveal className="reveal--wide">
              ...
              >
                ...
                <div className="invite-card">
                  ...
                  <h2 className="guest-name">Таныг</h2>
